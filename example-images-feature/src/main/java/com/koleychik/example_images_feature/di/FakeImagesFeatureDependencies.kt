package com.koleychik.example_images_feature.di
...
class FakeImagesFeatureDependencies: ImagesFeatureDependencies {
    override fun repository(): FilesRepository

    override fun navigator(): ImagesFeatureNavigationApi {
